...
contract NAIJADOGE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x53492e1B0BeAf8C4bD51ffe5873e58Ce2a489fFF); // Marketing Address
    ...
    string private _name = "NAIJA DOGE";
    string private _symbol = "NAIJADOGE";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x53492e1B0BeAf8C4bD51ffe5873e58Ce2a489fFF);
    }
